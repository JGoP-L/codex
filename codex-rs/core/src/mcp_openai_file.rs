...
//!   file inputs.
//! - Inspect validated `_meta["openai/fileUploadConfig"]` metadata to discover
//!   an explicit tool argument that opts uploaded local files into Library
//!   storage.
...
mod tests {
    ...
    #[test]
    fn store_in_oai_library_comes_from_explicit_tool_argument() {
